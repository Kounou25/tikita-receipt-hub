    ...
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-8 hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="space-y-3">
          <Label htmlFor="brandColor" className="dark:text-gray-200">{t('personalization.brandColor')}</Label>
        ...
        <div className="space-y-3">
          <Label className="dark:text-gray-200">{t('personalization.companyLogo')}</Label>
          <div className="flex items-center gap-4">
            {displayedProfile.avatar ? (
              <img
                src={displayedProfile.avatar}
                alt={t('personalization.companyLogo')}
