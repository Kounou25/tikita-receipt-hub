  ...
  return (
    <Card className="shadow-lg bg-white dark:bg-gray-900 dark:border-gray-700">
      <CardHeader className="flex items-center justify-between pb-6">
        <CardTitle className="text-2xl font-bold text-gray-900 dark:text-white">Articles</CardTitle>
        <Button
          onClick={addItem}
        ...
        {items.map((item: any) => (
          <div key={item.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
            <div className="md:col-span-6">
              <Label className="text-base font-medium text-gray-700 dark:text-gray-200 mb-3">Description *</Label>
              <Input
            ...
            <div className="md:col-span-2">
              <Label className="text-base font-medium text-gray-700 dark:text-gray-200 mb-3">Quantité</Label>
              <Input
                type="number"
                min="1"
                value={item.quantity}
            ...
            <div className="md:col-span-3">
              <Label className="text-base font-medium text-gray-700 dark:text-gray-200 mb-3">Prix unitaire (FCFA)</Label>
              <Input
                type="number"
                min="0"
